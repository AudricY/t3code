...
import Migration0026 from "./Migrations/026_ProjectionThreadsForkLineage.ts";
import Migration0027 from "./Migrations/027_ProjectionTurnsResumeCursor.ts";
...
export const migrationEntries = [
  ...
  [26, "ProjectionThreadsForkLineage", Migration0026],
  [27, "ProjectionTurnsResumeCursor", Migration0027],
] as const;
